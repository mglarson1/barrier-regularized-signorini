function [u,iite,resn] = solvereg_eps2(tri6,tri3,xnod,ynod,p,pow,gamma0)
% P2 version of solvereg_eps: Newton solver for the regularized Nitsche
% contact method with epsilon = dl^pow.
if nargin < 7, gamma0 = 20; end
...
for im = 1:nmult
    ...
    for j = 1:ngau
        ...
        [~,fix,fiy,~] = basescalar2(xm,ym,xc,yc);
